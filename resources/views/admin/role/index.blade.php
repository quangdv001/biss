    ...
    <div
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="#" class="btn btn-light-primary btn-sm font-weight-bold mr-2"
                ...
                <span class="font-weight-bold" id="kt_dashboard_daterangepicker_date">Aug
                    16</span>
            </a>
            <!--end::Daterange-->
...
<div class="content flex-column-fluid" id="kt_content">
    ...
    <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
        ...
        <div class="alert-text">
            Each column has an optional rendering control called columns.render which can be
            used to process the content of each cell before the data is used.
            See official documentation <a class="font-weight-bold"
                href="https://datatables.net/examples/advanced_init/column_render.html"
