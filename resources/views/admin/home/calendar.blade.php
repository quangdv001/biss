        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <h5 class="text-dark font-weight-bold my-1 mr-5">
                    <i class="flaticon2-calendar-8 text-primary"></i> Lịch công việc
                </h5>
        ...
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">
                    ...
                    Lịch deadline các task của tôi
                </h3>
            </div>
        </div>
        <div class="card-body">
...
function loadCalendarEvents(start, end, successCallback, failureCallback) {
    ...
    $.ajax({
        url: '{{ route("admin.home.getCalendarData") }}',
        method: 'GET',
        data: {
        ...
        error: function() {
            failureCallback();
            init.showNoty('Không thể tải dữ liệu lịch!', 'error');
        }
    });
}
